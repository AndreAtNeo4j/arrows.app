import type { RequestEnvelope } from '@arrows-code/messages';
...
export function makeRequester(channel: RequestChannel, opts: RequesterOptions = {}): Requester & { readonly size: number } {
